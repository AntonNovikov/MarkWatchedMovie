const API_URL =
    "https://api.themoviedb.org/3/search/movie?api_key=a8b943da8269eafbc1c6a4522c91dffb&query=";
...
form.addEventListener("submit", (e) => {
    ...
    document.querySelector(
        ".searchF"
    ).textContent = `Results for: ${search.value}`;
    search.value = "";
});

getMovies(
    "https://api.themoviedb.org/3/movie/popular?api_key=a8b943da8269eafbc1c6a4522c91dffb&page=1"
);
...
function showMovies(data) {
    ...
    data.results.forEach((element) => {
        ...
        <div class="movie-info">
            ...
            <div class="movie-rating movie-rating-${getClass(
              element.vote_average
            )}">${element.vote_average}</div>
